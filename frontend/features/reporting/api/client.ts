...
export const reportingApi = {
  ...
  vatReconciliation: (companyId: string, dateFrom: string, dateTo: string) =>
    apiClient.get<VatReconciliation>(`${BASE}/vat-reconciliation?date_from=${dateFrom}&date_to=${dateTo}`, {
      companyId,
    }),
